...
<div class="container-fluid">
        ...
        <table class="table table-striped">
            ...
            <tbody>
            	...
            	<tr>
            		...
            		<!-- BUTTON SHOW -->
            		<td>
            			<a class="btn btn-default" href="<?php echo e(URL::route('disciplina.show', $disciplina->id)); ?>">
            		...
            		<!-- BUTTON EDIT -->
					<td>
						<a href="<?php echo e(URL::route('disciplina.edit', $disciplina->id)); ?>" class="btn btn-warning">
    ...
    <hr>	
    <!--BUTTON ADD -->
    <a href="<?php echo e(URL::route('disciplina.create')); ?>" class="btn btn-primary ">Adicionar nova Disciplina</a>
</div>

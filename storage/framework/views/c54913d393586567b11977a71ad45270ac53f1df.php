...
<div class="container-fluid">
    ...
    <div class="table-responsive">
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <?php $__currentLoopData = $estagios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $estagio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <!-- BUTTON SHOW -->
                    <td>
                        <a class="btn btn-default" href="<?php echo e(URL::route('estagio.show', $estagio->id)); ?>">
                    ...
                    <!-- BUTTON EDIT -->
                    <td>
                        <a class="btn btn-warning" href="<?php echo e(URL::route('estagio.edit', $estagio->id)); ?>">
                    ...
                    <!-- BUTTON DESTROY -->
                    <td>
                        <form action="<?php echo e(route('estagio.destroy', $estagio->id)); ?>" method="POST">
    ...
    <hr>
    <!--BUTTON ADD -->
    <a href="<?php echo e(URL::route('estagio.create')); ?>" class="btn btn-primary">Adicionar novo Estágio</a>
</div>

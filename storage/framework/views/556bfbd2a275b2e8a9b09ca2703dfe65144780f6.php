...
<div class="container-fluid">
		...
		<table class="table table-striped">
			...
			<tbody>
				...
				<tr>
					...
					<!-- BUTTON SHOW -->
					<td>
						<a class="btn btn-default" href="<?php echo e(URL::route('ano.show', $ano->id)); ?>">
					...
					<!-- BUTTON EDIT -->
					<td>
						<a class="btn btn-warning" href="<?php echo e(URL::route('ano.edit', $ano->id)); ?>">
					...
					<!-- BUTTON DESTROY -->
					<td>
						<form action="<?php echo e(route('ano.destroy', $ano->id)); ?>" method="POST">
	...
	<hr>
	<!--BUTTON ADD -->
	<a href="<?php echo e(URL::route('ano.create')); ?>" class="btn btn-primary">Adicionar novo Ano</a>
</div>

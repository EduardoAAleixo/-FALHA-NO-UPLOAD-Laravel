...
<div class="container-fluid">
    	...
    	<table class="table table-striped">
			...
			<tbody>
    			...
    			<tr>
    				...
    				<!-- BUTTON SHOW -->
    				<td>
    					<a class="btn btn-default" href="<?php echo e(URL::route('aviso.show', $aviso->id)); ?>"><span class="glyphicon glyphicon-tags"></span></a> 
    				</td>

					<!-- BUTTON EDIT -->
					<td>
                        <a class="btn btn-warning" href="<?php echo e(URL::route('aviso.edit', $aviso->id)); ?>"><span class="glyphicon glyphicon-cog"></span></a>
                    </td>

					<!-- BUTTON DESTROY -->
					<td>
    					<form action="<?php echo e(route('aviso.destroy', $aviso->id)); ?>" method="POST">
	...
	<hr>	
    <!--BUTTON ADD -->
    <a href="<?php echo e(URL::route('aviso.create')); ?>" class="btn btn-primary">Adicionar novo Aviso</a>
</div>

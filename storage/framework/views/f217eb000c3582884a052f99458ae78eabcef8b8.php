...
<div class="conteiner-fluid">
		...
		<table class="table table-striped">
			...
			<?php $__currentLoopData = $alunos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aluno): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>:
				...
				<tr>
					...
					<!-- BUTTON EDIT -->
					<td>
						<a class="btn btn-warning" href="<?php echo e(URL::route('aluno.edit', $aluno->id)); ?>">
					...
					<!-- BUTTON DESTROY -->
					<td>
						<form action="<?php echo e(route('aluno.destroy', $aluno->id)); ?>" method="POST"> 
	...
	<hr>
	<!--BUTTON ADD-->
	<a href="<?php echo e(URL::route('aluno.create')); ?>" class="btn btn-primary">Adicionar novo Aluno</a>
</div>
